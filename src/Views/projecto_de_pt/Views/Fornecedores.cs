...
namespace projecto_de_pt.Views
{
    public partial class Fornecedores : Form
    {
        ...
        private void InitializeDataView()
        {
            ...
            {
                Tabela1.Rows.Add(item.nome, item.numero_de_telefone, item.email, item.produto);
            }
        ...
        public class Item
        {
            ...
            public string numero_de_telefone { get; set; }
        ...
        private void Tabela1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
